...
class ElasticaPublisherSubscriber(Node):
    ...
    def timer_callback(self):
        ...
        self.rod_state_msg.rod_tip_orientation_w_1.data = np.squeeze(self.rod_state[0]["rod_tip_orientation_w"]).tolist()
        self.rod_state_msg.rod_tip_orientation_x_1.data = np.squeeze(self.rod_state[0]["rod_tip_orientation_x"]).tolist()
        self.rod_state_msg.rod_tip_orientation_y_1.data = np.squeeze(self.rod_state[0]["rod_tip_orientation_y"]).tolist()
        self.rod_state_msg.rod_tip_orientation_z_1.data = np.squeeze(self.rod_state[0]["rod_tip_orientation_z"]).tolist()
        ...
        self.rod_state_msg.rod_tip_orientation_w_2.data = np.squeeze(self.rod_state[1]["rod_tip_orientation_w"]).tolist()
        self.rod_state_msg.rod_tip_orientation_x_2.data = np.squeeze(self.rod_state[1]["rod_tip_orientation_x"]).tolist()
        self.rod_state_msg.rod_tip_orientation_y_2.data = np.squeeze(self.rod_state[1]["rod_tip_orientation_y"]).tolist()
        self.rod_state_msg.rod_tip_orientation_z_2.data = np.squeeze(self.rod_state[1]["rod_tip_orientation_z"]).tolist()
        ...
        self.rod_state_msg.rod_tip_orientation_w_3.data = np.squeeze(self.rod_state[2]["rod_tip_orientation_w"]).tolist()
        self.rod_state_msg.rod_tip_orientation_x_3.data = np.squeeze(self.rod_state[2]["rod_tip_orientation_x"]).tolist()
        self.rod_state_msg.rod_tip_orientation_y_3.data = np.squeeze(self.rod_state[2]["rod_tip_orientation_y"]).tolist()
        self.rod_state_msg.rod_tip_orientation_z_3.data = np.squeeze(self.rod_state[2]["rod_tip_orientation_z"]).tolist()
        ...
        self.rod_state_msg.rod_tip_orientation_w_4.data = np.squeeze(self.rod_state[3]["rod_tip_orientation_w"]).tolist()
        self.rod_state_msg.rod_tip_orientation_x_4.data = np.squeeze(self.rod_state[3]["rod_tip_orientation_x"]).tolist()
        self.rod_state_msg.rod_tip_orientation_y_4.data = np.squeeze(self.rod_state[3]["rod_tip_orientation_y"]).tolist()
        self.rod_state_msg.rod_tip_orientation_z_4.data = np.squeeze(self.rod_state[3]["rod_tip_orientation_z"]).tolist()
        ...
        self.rod_state_msg.rod_tip_orientation_w_5.data = np.squeeze(self.rod_state[4]["rod_tip_orientation_w"]).tolist()
        self.rod_state_msg.rod_tip_orientation_x_5.data = np.squeeze(self.rod_state[4]["rod_tip_orientation_x"]).tolist()
        self.rod_state_msg.rod_tip_orientation_y_5.data = np.squeeze(self.rod_state[4]["rod_tip_orientation_y"]).tolist()
        self.rod_state_msg.rod_tip_orientation_z_5.data = np.squeeze(self.rod_state[4]["rod_tip_orientation_z"]).tolist()
        ...
        self.rod_state_msg.rod_tip_orientation_w_6.data = np.squeeze(self.rod_state[5]["rod_tip_orientation_w"]).tolist()
        self.rod_state_msg.rod_tip_orientation_x_6.data = np.squeeze(self.rod_state[5]["rod_tip_orientation_x"]).tolist()
        self.rod_state_msg.rod_tip_orientation_y_6.data = np.squeeze(self.rod_state[5]["rod_tip_orientation_y"]).tolist()
        self.rod_state_msg.rod_tip_orientation_z_6.data = np.squeeze(self.rod_state[5]["rod_tip_orientation_z"]).tolist()
