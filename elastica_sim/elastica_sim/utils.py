...
def uniformtorques_mag_cal(torque,direction_UniformTorques,n_elem,n_segments):
    uniformtorques_mag = []
    for i in range(n_segments):
        uniformtorques_mag.append(((torque[i] * direction_UniformTorques[i]) / n_elem)) #Uniform torque on one element
