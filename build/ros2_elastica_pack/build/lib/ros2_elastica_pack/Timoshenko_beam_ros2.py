...
class MinimalPublisher(Node):
    global n_elem , density, nu , E , poisson_ratio, start,direction, normal , base_length , \
    base_radius , base_area 
        
    # n_elem =  100, density = 1000, nu = 0.1, E = 1e6, poisson_ratio = 99, start = np.zeros((3,)) 
    # direction = np.array([0.0, 0.0, 1.0]) , normal = np.array([0.0, 1.0, 0.0]), base_length = 3.0 
    # base_radius = 0.25, base_area = np.pi * base_radius ** 2
